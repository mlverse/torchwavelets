test_that("wavelet_transform fields and methods (using Morlet wavelet)", {
  ...
  x <- wtf$scales
  y <- torch::torch_tensor(c(
    0.19360266, 0.2111252, 0.23023366, 0.25107159, 0.27379551,
  ...
  y <- torch::torch_tensor(c(
    0.2, 0.21810155, 0.23784142, 0.25936791, 0.28284271,
  ...
  y <- torch::torch_tensor(c(
    5., 4.58502022, 4.20448208, 3.85552706, 3.53553391,
  ...
  x7r <- x[[7]]$real
  x7i <- x[[7]]$imag
  y7r <- torch::torch_tensor(c(
    -2.29166061e-06, -7.08678266e-06, 5.18883299e-05, -2.17701978e-06,
  ...
  y7i <- torch::torch_tensor(c(
    2.37992103e-06, -1.20308152e-05, -1.38241432e-05, 1.87910148e-04,
  ...
  y <- c(
    19, 21, 23, 25, 27, 29, 33, 35, 39, 43, 47, 51, 55,
  ...
  y <- c(
    9, 10, 11, 12, 13, 14, 16, 17, 19, 21, 23, 25, 27,
